...
class ApplyTenderNotification extends Notification
{
    use Queueable;
     ...
     * @return void
     */
    public function __construct($tender, $data)
    {
        $this->tender = $tender;
        $this->data = $data;
    }
    ...
    public function toMail($notifiable)
    {
        return (new MailMessage)
                    ->line(new HtmlString('<strong>New Apply from your tender: </strong>'.$this->tender->title))
